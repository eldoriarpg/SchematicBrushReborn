...
public class Settings extends AdvancedCommand {
    public Settings(Plugin plugin, Configuration configuration, RenderService renderService, NotifyListener notifyListener, IMessageBlockerService messageBlocker) {
        super(plugin);
